...
NBL=$2
#KERNEL=$3
KERNEL=~/Big_LITTLE/Architectures/binaries/linux-arm64-gem5/vmlinux
#MACHINE=$4
...
./build/ARM/gem5.fast -d $DIR configs/example/fs.py --caches --l2cache --big-little \
    --cpu-type-big=A57 --cpu-type-little=MinorCPU \
    ...
    --kernel $KERNEL --machine-type=$MACHINE --disk-image $DISK \
