...
then 
    ...
    ./build/ARM/gem5.opt -d $6 configs/example/fs.py -n $1 --machine-type $4 --kernel $2 --dtb-filename $3 --disk-image $5 --caches --l2cache --mem-size 256MB --mem-type LPDDR3_1600_x32
